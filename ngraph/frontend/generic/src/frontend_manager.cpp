...
namespace ngraph
{
    namespace frontend
    {
        ...
        public:
            ...
            ngraph::PartialShape getPartialShape (const Place& place) const
            {
                return m_inputModel->getPartialShape(place.m_impl->m_place);
            }
        ...
        ngraph::PartialShape InputModel::getPartialShape (const Place& place) const
        {
            return m_impl->getPartialShape(place);
        }
